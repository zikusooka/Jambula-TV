...
__plugin__ = "Analogue Live TV"
__author__ = 'Joseph Zikusooka <joseph@zikusooka.com>'
__url__ = 'http://joseph.zikusooka.com'
__date__ = '4-05-2015'
__version__ = '1.2.7'
__settings__ = xbmcaddon.Addon(id='plugin.video.analogue.tv')



class AnalogueLiveTVPlugin(object):
        
    
    def connect_to_db(self):
        path = xbmc.translatePath('special://profile/addon_data/plugin.video.analogue.tv/')
    ...
    def get_cache_dir(self):
        ...
        path = xbmc.translatePath('special://profile/addon_data/plugin.video.analogue.tv/cache/')
        if not os.path.exists(path):
            os.makedirs(path)
        return path
...
if __name__ == '__main__':
    plugin = AnalogueLiveTVPlugin(*sys.argv)
    plugin()
